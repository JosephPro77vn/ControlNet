...
class CelebDataset(Dataset):
    ...
    def __init__(self, split, im_path, im_size=256, im_channels=3, im_ext='jpg',
                 use_latents=False, latent_path=None, shuffle = False, subset = None,  return_hint=False, condition_config=None):
        self.split = split
    ...
    def __getitem__(self, index):
        ...
        if self.use_latents:
            ...
            if self.return_hints:
                ...
                canny_image = Image.open(self.images[index])
                canny_image = canny_image.resize((512, 512))  # Resize here
                canny_image = np.array(canny_image)
